...
//------------------------------------------------------------------------------
//
// This example intentionally uses a public echo service. Replace the endpoint
// with the service used by your application.
//
// The receive is serialized after the send on the same strand, so the example
// has deterministic operation ordering without requiring application locks.
//------------------------------------------------------------------------------
